  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:10px">
        <h1 class="h1" style="color:rgba(0, 150, 136, 1);fontSize:28px;">汽车售票网站设计注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="用户名" class="input" v-if="tableName=='kehu'">
			...
			<el-form-item label="姓名" class="input" v-if="tableName=='kehu'">
			...
			<el-form-item label="年龄" class="input" v-if="tableName=='kehu'">
			...
			<el-form-item label="手机" class="input" v-if="tableName=='kehu'">
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='kehu'">
			...
			<!-- <div v-if="tableName=='huiyuan'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.zhekou" class="input" type="text" placeholder="折扣">
			   </div>
			 </div> -->
			<el-form-item label="折扣" class="input" v-if="tableName=='huiyuan'">
			  <el-input v-model="ruleForm.zhekou" autocomplete="off" placeholder="折扣" type="text" />
			</el-form-item>
...
export default {
  ...
  methods: {
    ...
    // 注册
    login() {
      if((!this.ruleForm.yonghuming) && `kehu` == this.tableName){
