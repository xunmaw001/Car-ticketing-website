...
export default {
  ...
  computed: {
    zongjine:{
      get: function () {
        return 1*this.ruleForm.piaoshu*this.ruleForm.piaojia
      }
    },
  },
  created() {
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `goupiaojilu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.goupiaojiluCrossAddOrUpdateFlag = false;
                  this.parent.search();
