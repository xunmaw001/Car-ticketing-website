<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="班次类型" prop="bancileixing">
          <el-input v-model="ruleForm.bancileixing" 
              placeholder="班次类型" clearable  :readonly="ro.bancileixing"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="车辆照片" prop="cheliangzhaopian">
          <el-input v-model="ruleForm.cheliangzhaopian" 
              placeholder="车辆照片" clearable  :readonly="ro.cheliangzhaopian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="车辆照片" prop="cheliangzhaopian">
              <el-input v-model="ruleForm.cheliangzhaopian" 
                placeholder="车辆照片" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="发车时间" prop="facheshijian">
          <el-input v-model="ruleForm.facheshijian" 
              placeholder="发车时间" clearable  :readonly="ro.facheshijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="发车时间" prop="facheshijian">
              <el-input v-model="ruleForm.facheshijian" 
...
export default {
  ...
  computed: {
    zongjine:{
      get: function () {
        return 1*this.ruleForm.piaoshu*this.ruleForm.piaojia*this.ruleForm.zhekou
      }
    },
  },
  created() {
  ...
  methods: {
    ...
    info(id) {
      this.$http({
        url: `huiyuangoupiaojilu/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `huiyuangoupiaojilu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.huiyuangoupiaojiluCrossAddOrUpdateFlag = false;
                  this.parent.search();
