    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="会员等级" prop="huiyuandengji">
          <el-select  @change="huiyuandengjiChange" v-model="ruleForm.huiyuandengji" placeholder="请选择会员等级">
            <el-option
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="备注说明" prop="beizhushuoming">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="备注说明"
                  v-model="ruleForm.beizhushuoming" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.beizhushuoming" label="备注说明" prop="beizhushuoming">
                    <span>{{ruleForm.beizhushuoming}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
