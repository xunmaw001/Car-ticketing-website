<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="班次名称" prop="bancimingcheng">
          <el-input v-model="ruleForm.bancimingcheng" 
              placeholder="班次名称" clearable  :readonly="ro.bancimingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="班次名称" prop="bancimingcheng">
              <el-input v-model="ruleForm.bancimingcheng" 
                placeholder="班次名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="班次类型" prop="bancileixing">
          <el-select v-model="ruleForm.bancileixing" placeholder="请选择班次类型">
            <el-option
                v-for="(item,index) in bancileixingOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="班次类型" prop="bancileixing">
	      <el-input v-model="ruleForm.bancileixing"
                placeholder="班次类型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="出发站" prop="chufazhan">
          <el-input v-model="ruleForm.chufazhan" 
              placeholder="出发站" clearable  :readonly="ro.chufazhan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="出发站" prop="chufazhan">
              <el-input v-model="ruleForm.chufazhan" 
                placeholder="出发站" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="到达站" prop="daodazhan">
          <el-input v-model="ruleForm.daodazhan" 
              placeholder="到达站" clearable  :readonly="ro.daodazhan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="到达站" prop="daodazhan">
              <el-input v-model="ruleForm.daodazhan" 
                placeholder="到达站" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="发车时间" prop="facheshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.facheshijian" 
                type="datetime"
                placeholder="发车时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.facheshijian" label="发车时间" prop="facheshijian">
              <el-input v-model="ruleForm.facheshijian" 
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="已经发车" prop="yijingfache">
          <el-select v-model="ruleForm.yijingfache" placeholder="请选择已经发车">
            <el-option
                v-for="(item,index) in yijingfacheOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="已经发车" prop="yijingfache">
	      <el-input v-model="ruleForm.yijingfache"
                placeholder="已经发车" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="途径站点" prop="tujingzhandian">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.tujingzhandian" label="途径站点" prop="tujingzhandian">
                    <span v-html="ruleForm.tujingzhandian"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='bancimingcheng'){
            this.ruleForm.bancimingcheng = obj[o];
	    this.ro.bancimingcheng = true;
            continue;
          }
          if(o=='bancileixing'){
            this.ruleForm.bancileixing = obj[o];
	    this.ro.bancileixing = true;
            continue;
          }
	    ...
	    this.ro.cheliangzhaopian = true;
          ...
          if(o=='chufazhan'){
            this.ruleForm.chufazhan = obj[o];
	    this.ro.chufazhan = true;
            continue;
          }
          if(o=='daodazhan'){
            this.ruleForm.daodazhan = obj[o];
	    this.ro.daodazhan = true;
            continue;
          }
          if(o=='facheshijian'){
            this.ruleForm.facheshijian = obj[o];
	    this.ro.facheshijian = true;
            continue;
          }
          if(o=='piaojia'){
	    ...
	    this.ro.piaojia = true;
          ...
          if(o=='yijingfache'){
            this.ruleForm.yijingfache = obj[o];
	    this.ro.yijingfache = true;
            continue;
          }
          if(o=='tujingzhandian'){
	...
	this.ruleForm.tujingzhandian = this.ruleForm.tujingzhandian.replace(reg,'../../../ssm58ip7/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `keyunbanci/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.keyunbanciCrossAddOrUpdateFlag = false;
                  this.parent.search();
