...
public class KehuController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		KehuEntity user = kehuService.selectOne(new EntityWrapper<KehuEntity>().eq("yonghuming", username));
    ...
    public R register(@RequestBody KehuEntity kehu){
    	...
    	KehuEntity user = kehuService.selectOne(new EntityWrapper<KehuEntity>().eq("yonghuming", kehu.getYonghuming()));
		if(user!=null) {
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,KehuEntity kehu, HttpServletRequest request){
    ...
    public R add(@RequestBody KehuEntity kehu, HttpServletRequest request){
    	...
    	kehu.setUserid((Long)request.getSession().getAttribute("userId"));
